                    ...
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(
                          ...
                          child: SelectableText(s.answerText, style: const TextStyle(fontSize: 13, height: 1.6)),
                        ),
                        if (isReviewed) ...[
                          const SizedBox(height: 8),
                          if (s.grade != null)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: SelectableText(s.answerText, style: const TextStyle(fontSize: 12, height: 1.6)),
                      ),
                      const SizedBox(height: 12),
